...
tv1 = Tv(10,"white","65",2)
print(f"철수 tv 사양:{tv1.channel},{tv1.color},{tv1.size},{tv1.volume}")
tv2 = Tv(7,"pink","65",5)
print(f"영희 tv 사양:{tv2.channel},{tv2.color},{tv2.size},{tv2.volume}")
tv3 = Tv(1,"silver","65",3)
print(f"반장 tv 사양:{tv3.channel},{tv3.color},{tv3.size},{tv3.volume}")
